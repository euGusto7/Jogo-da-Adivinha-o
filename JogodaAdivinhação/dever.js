...
function validarNumeroDigitado(numero) {
    if(numero <= 0 || numero > 100) {
        ...
        mensagemRapida('Você não está sendo um(a) mentalista! Digite um número inteiro entre 1 e 100.')
        bloquearBtnChutar()
        inputNumero.value = ''
    } else {
...
function gameOver(situacao) {
    switch (situacao) {
        ...
        case 'Acertou':
            ...
            mensagemRapida('Congratulations!! Você acertou, o número secreto era ' + numeroSecreto)
        break
